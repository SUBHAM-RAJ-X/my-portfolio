...
const HandsOnTechnicalProjects = [
    ...
    // },
    {
        ...
        organization: 'Personal Project',
        services: ['Frontend Development', 'UI/UX Design'],
        link: 'https://github.com/SUBHAM-RAJ-X/library',
        details: {
            description: 'Designed and developed a clean, responsive, and user-friendly library interface focused on smooth navigation and intuitive user experience.',
            lessons: [
                'Built reusable and modular React components for scalable frontend architecture.',
                'Applied modern UI/UX principles to improve readability, spacing, and user flow.',
                'Enhanced responsiveness and performance for seamless experience across devices.'
            ],
            screenshots: [
                require('../../assets/images/Screenshot 2026-02-23 185059.png'),
                require('../../assets/images/Screenshot 2026-02-23 185120.png'),
                require('../../assets/images/Screenshot 2026-02-23 185134.png'),
            ]
        }
    },
];
